<script>
    import AiLibraryTableRow from "./AiLibraryTableRow.svelte";
        ...
        <div class="mt-4 overflow-auto">
            <table class="table">
                <thead>
                    <tr>
                        <th>
                            <input id="check_all" aria-label="Check all" type="checkbox" class="checkbox checkbox-sm" />
                        </th>
                        <th>ID</th>
                        <th>User</th>
                        <th>Type</th>
                ...
                <tbody>
                    {#each aiLibraryData as library, index (index)}
                        <AiLibraryTableRow {...library} />
                    {/each}
                </tbody>
            </table>
        </div>
...
<dialog id="apps-ai-library-delete" class="modal">
    <div class="modal-box">
        ...
        <p class="py-4">You are about to delete this item. Would you like to proceed further ?</p>
