<script>
    import HelpTopic from "./HelpTopic.svelte";
...
<div class="min-sm:container">
    ...
    <div class="mt-6 grid grid-cols-1 gap-5 sm:grid-cols-2 xl:grid-cols-4">
        {#each helpTopics as topic, index (index)}
            <HelpTopic {...topic} />
        {/each}
    </div>
    ...
    <div class="mt-8 grid gap-8 md:grid-cols-2">
        <div class="card bg-base-100 h-fit shadow">
            <div class="card-body pb-0">
                ...
                <div class="-mx-4 mt-2">
                    {#each getUserManagementFAQs as faq, index (index)}
        ...
        <div class="card bg-base-100 h-fit shadow">
            <div class="card-body pb-0">
                ...
                <div class="-mx-4 mt-2">
                    {#each getSystemFAQs as faq, index (index)}
                        <div class="collapse-plus collapse">
                            <input type="radio" aria-label="Accordion radio" class="cursor-pointer" name="accordion" />
                            <div class="collapse-title cursor-pointer">{faq.question}</div>
                            <div class="collapse-content">{faq.answer}</div>
