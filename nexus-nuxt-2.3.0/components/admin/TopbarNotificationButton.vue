    ...
    <div class="dropdown dropdown-bottom sm:dropdown-end max-sm:dropdown-center">
        ...
        <div
            ...
            <div class="flex items-center justify-between px-2">
                ...
                <button tabIndex="0" class="btn btn-sm btn-circle btn-ghost" aria-label="Close" @click="closeMenu">
            ...
            <div class="mt-2">
                <div class="rounded-box hover:bg-base-200 flex cursor-pointer gap-3 px-2 py-1.5 transition-all">
                    <img src="/images/avatars/4.png" class="bg-base-200 mask mask-squircle size-10 p-0.5" alt="" />
                    <div class="grow">
                ...
                <div class="rounded-box hover:bg-base-200 flex cursor-pointer gap-3 px-2 py-1.5 transition-all">
                    <img src="/images/avatars/5.png" class="bg-base-200 mask mask-squircle size-10 p-0.5" alt="" />
                    <div class="grow">
                        <p class="text-sm leading-tight">A new review has been submitted for product</p>
                        <p class="text-base-content/60 text-end text-xs leading-tight">1 Hour ago</p>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-2">
                <div class="rounded-box hover:bg-base-200 flex cursor-pointer gap-3 px-2 py-1.5 transition-all">
                    <img src="/images/avatars/1.png" class="bg-base-200 mask mask-squircle size-10 p-0.5" alt="" />
                    <div class="grow">
                ...
                <div class="rounded-box hover:bg-base-200 flex cursor-pointer gap-3 px-2 py-1.5 transition-all">
                    <img src="/images/avatars/2.png" class="bg-base-200 mask mask-squircle size-10 p-0.5" alt="" />
                    <div class="grow">
                        <p class="text-sm leading-tight">Product &apos;ABC123&apos; is running low in stock.</p>
                        <p class="text-base-content/60 text-end text-xs leading-tight">3 Days ago</p>
                    </div>
                </div>
                <div class="rounded-box hover:bg-base-200 flex cursor-pointer gap-3 px-2 py-1.5 transition-all">
                    <img src="/images/avatars/3.png" class="bg-base-200 mask mask-squircle size-10 p-0.5" alt="" />
                    <div class="grow">
