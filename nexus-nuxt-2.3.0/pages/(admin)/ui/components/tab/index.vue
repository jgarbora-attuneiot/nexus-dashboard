        ...
        <div class="mt-6 grid gap-6 lg:grid-cols-2">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-4">
                        <div role="tablist" class="tabs tabs-border">
                            <a role="tab" class="tab"> Tab 1 </a>
                            <a role="tab" class="tab tab-active text-primary"> Tab 2 </a>
                            <a role="tab" class="tab"> Tab 3 </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="card card-border bg-base-100">
                <div class="card-body">
                    ...
                    <div class="mt-4">
                        <div role="tablist" class="tabs tabs-lift">
                            <input type="radio" name="demo-tabs-radio" role="tab" class="tab" aria-label="Tab 1" />
                            <div class="tab-content border-base-200 bg-base-100 p-6">Tab content 1</div>
                            ...
                            <input
                                ...
                                aria-label="Tab 2"
                                defaultChecked />
                            <div class="tab-content border-base-200 bg-base-100 p-6">Tab content 2</div>

                            <input type="radio" name="demo-tabs-radio" role="tab" class="tab" aria-label="Tab 3" />
                            <div class="tab-content border-base-200 bg-base-100 p-6">Tab content 3</div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="card card-border bg-base-100">
                <div class="card-body">
                    <div class="card-title">Bottom Tab</div>
                    <div class="mt-4">
            ...
            <div class="card card-border bg-base-100">
                <div class="card-body">
                    ...
                    <div class="mt-4 flex flex-col items-center gap-2">
                        ...
                        <div role="tablist" class="tabs tabs-xl">
                            <a role="tab" class="tab"> Tab 1 </a>
                            <a role="tab" class="tab tab-active"> Tab 2 </a>
                            <a role="tab" class="tab"> Tab 3 </a>
                        </div>
