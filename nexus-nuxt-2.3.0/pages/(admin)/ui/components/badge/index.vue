        ...
        <div class="mt-6 grid gap-6 lg:grid-cols-2">
            ...
            <div class="card card-border bg-base-100">
                <div class="card-body">
                    ...
                    <div class="mt-4 flex flex-wrap items-center gap-3">
                        <div class="badge badge-primary badge-xl"></div>
                ...
                <div class="card-body">
                    ...
                    <div class="mt-4 flex flex-wrap gap-2">
                        ...
                        <div class="badge badge-error">
                            <span class="iconify lucide--ban"></span>
                            Error
                        </div>
                    </div>
                </div>
            ...
            <div class="card card-border bg-base-100">
                <div class="card-body">
                    ...
                    <div class="mt-4 flex flex-wrap items-center gap-3">
                        <button class="btn">Inbox <span class="badge badge-sm">+99</span></button>
                        <button class="btn">Inbox <span class="badge badge-primary badge-sm">+99</span></button>
                    </div>
                </div>
            </div>
        </div>
