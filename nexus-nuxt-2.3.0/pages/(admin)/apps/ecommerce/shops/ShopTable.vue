...
import ShopTableRow from "./ShopTableRow.vue";
...
<template>
    <div>
            ...
            <div class="card-body p-0">
                <div class="flex items-center justify-between px-5 pt-5">
                    <div class="inline-flex items-center gap-3">
                        ...
                        <div class="hidden sm:block">
                            <select class="select select-sm w-40" aria-label="Verification status">
                    ...
                    <div class="inline-flex items-center gap-3">
                        <NuxtLink
                            href="/apps/ecommerce/shops/create"
                            aria-label="Create shop link"
                            class="btn btn-primary btn-sm max-sm:btn-square">
                            <span class="iconify lucide--plus size-4"></span>
                            <span class="hidden sm:inline">New Shop</span>
                        </NuxtLink>
                ...
                <div class="mt-4 overflow-auto">
                    <table class="table">
                        ...
                        <tbody>
                            <ShopTableRow v-for="(shop, index) in shopsData" :key="index" v-bind="shop" />
                        </tbody>
                    </table>
                </div>
                ...
                <div class="flex items-center justify-between p-6">
                    ...
                    <span class="text-base-content/80 hidden text-sm lg:inline">
                        Showing <span class="text-base-content font-medium">1 to 20</span> of 457 items
                    </span>
        ...
        <dialog id="apps-shop-delete" class="modal">
            <div class="modal-box">
                ...
                <p class="py-4">You are about to delete this shop. Would you like to proceed further ?</p>
