...
<template>
    <div>
                ...
                <div class="flex items-center justify-between px-5 pt-5">
                    <div class="inline-flex items-center gap-3">
                        ...
                        <div class="hidden sm:block">
                            <select class="select select-sm w-40" aria-label="Verification">
        ...
        <dialog id="apps-customer-delete" class="modal">
            <div class="modal-box">
                ...
                <p class="py-4">You are about to delete this customer. Would you like to proceed further ?</p>
