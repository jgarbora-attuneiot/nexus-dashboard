        ...
        <div className="drawer drawer-end">
            ...
            <div className="drawer-side z-[50]">
                <label
                    ...
                    aria-hidden
                />
                <div className="bg-base-100 text-base-content h-full w-72 sm:w-96">
                    <div className="bg-base-200 flex justify-between px-5 py-4">
                        ...
                        <div className="mt-3 grid grid-cols-3 gap-3">
                            ...
                            <div
                                ...
                                <div className="bg-base-200 rounded-box pt-5 pb-3 text-center">
                                    ...
                                    <p className="mt-1.5 text-xs capitalize sm:text-sm">Material Dark</p>
                                </div>
