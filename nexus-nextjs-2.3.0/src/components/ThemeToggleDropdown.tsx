        ...
        <>
            <div className={`dropdown ${dropdownClass}`}>
                <div tabIndex={0} role="button" className={`${triggerClass ?? ""}`} aria-label="Theme toggle">
                    ...
                    />
                    <span
                        className={`iconify lucide--palette hidden size-4 group-data-[theme=contrast]/html:inline group-data-[theme=dim]/html:inline group-data-[theme=material]/html:inline group-data-[theme=material-dark]/html:inline ${iconClass ?? ""}`}
                    />
                </div>
                <ul
                    tabIndex={0}
