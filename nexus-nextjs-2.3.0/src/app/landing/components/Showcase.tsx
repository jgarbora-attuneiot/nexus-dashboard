            ...
            <div className="relative container py-8 md:py-12 xl:py-16 2xl:py-24">
                <div className="relative z-10 grid gap-12 lg:grid-cols-7 lg:gap-24">
                    <div className="lg:col-span-3">
                        <div className="inline-flex items-center rounded border border-teal-500/5 bg-teal-500/5 p-2.5">
                        ...
                        <div className="mt-6">
                            <Link href="/ui/components/accordion" className="btn btn-outline btn-sm btn-neutral">
                                View Components
                    ...
                    <div className="relative lg:col-span-4">
                        ...
                        <div className="from-base-100/60 to-base-100 rounded-box bg-linear-to-tl to-[20%] p-10 text-center backdrop-blur-[4px]">
                                    ...
                                    <div className="card bg-base-100 card-border">
                                        <div className="card-body text-start">
                                            <div className="flex items-center gap-3">
                                                <div className="avatar">
                                                    <div className="bg-base-200 mask mask-squircle bg-base-300 w-8">
