...
export const ShopTable = () => {
    return (
        <>
            ...
            <dialog id="apps-shop-delete" className="modal">
                <div className="modal-box">
                    ...
                    <p className="py-4"> You are about to delete this shop. Would you like to proceed further ?</p>
